      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            child: Container(
              child: Image.asset(
                'assets/icons/onboardImage1.png',
                fit: BoxFit.cover,
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Check assets/icons/onboardImage1.png',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 12.sp,
                            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Tell us your food preferences—whether you’re vegan, gluten-free, or have any special dietary needs.',
                        style: GoogleFonts.dmSans(
                          fontSize: 13.sp,
